...
// \brief A copy of vcl_where_root_dir for boxm2/ocl.  

// Note: The make system (eg cmake) should generate a file, boxm2_ocl_where_root_dir.h, from
...
#ifndef BOXM2_OPENCL_SOURCE_DIR // file guard
#define BOXM2_OPENCL_SOURCE_DIR ""
#endif
